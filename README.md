...
***
tips   
package.jso: con nombre, versión, descripción, autores, licencia, 
dependencias, scripts (pretest, test, ...), main, bin
  gitignor- para ignorar node_modules u otras carpetas que no deban incluirse en control de versiones (git).
...
### anexo 
aprendiendo a crear redme con codigo. desglosandolo
[Markdown](https://es.wikipedia.org/wiki/Markdown) lo 1ro hace referencia al objeto y lo segundo es el link de ingreso. se muta visualmente y se ingresa a [dentro el link].
[Node.js](https://nodejs.org/) en este 2do caso se usa la palabra[node.js] para indicar como parte del parrafo y contenido textual y a la vez da un acceso de linkeo a una ruta url. este es el links () anclado [dentro el link]
`README.md`se resalta la palabra o destaca 
 _links_ 
Estos archivos `Markdown` normalmente contienen(vínculos/ligas) que
